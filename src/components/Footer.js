        ...
        <section id="banner">
          <div className="container-fluid" id="banner-container">
            <div className="row" id="banner-row">
              ...
              <div className="col-md-4 mt-4 justify-content-center d-flex align-items-center" id="footer-col3">
                <a style={{color: 'white'}} target="_blank" rel="noreferrer" href="https://www.linkedin.com/feed/"><i className="fab fa-2x  fa-linkedin me-2" /></a>&nbsp;
                <a style={{color: 'white'}} target="_blank" rel="noreferrer" href="https://github.com/"><i className="fab fa-2x fa-github me-2" /></a>&nbsp;
                <a style={{color: 'white'}} target="_blank" rel="noreferrer" href="/"><i className="fab fa-2x fa-instagram" /></a>
              </div>
